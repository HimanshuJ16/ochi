...
const Footer = () => {
  return (
    <div className='w-full h-screen flex gap-5 p-16'>
      <div className='w-1/2 h-full flex flex-col justify-between font-grotesk'>
        <div className='heading'>
          <h1 className='text-[9vw] uppercase leading-none -mb-5 text-[#212121]'>Eye-</h1>
          <h1 className='text-[9vw] uppercase leading-none -mb-5 text-[#212121]'>Opening</h1>
        </div>
      ...
      <div className='w-1/2'>
        <h1 className='text-[9vw] uppercase leading-none -mb-5 text-[#212121] font-grotesk'>Presentations</h1>
        <div className='dets font-neue mt-10'>
          <p className='block text-lg font-light text-[#515151]'>S:</p>
          <a className='block text-lg underline underline-offset-5 font-light text-[#515151] mt-5' href="">Facebook</a>
          <a className='block text-lg underline underline-offset-5 font-light text-[#515151]' href="">Instagram</a>
          <a className='block text-lg underline underline-offset-5 font-light text-[#515151]' href="">Twitter</a>
          <a className='block text-lg underline underline-offset-5 font-light text-[#515151]' href="">Linkedin</a>
        </div>
        <div className='dets font-neue mt-10'>
          <p className='block text-lg font-light text-[#515151]'>L:</p>
          <p className='block text-lg underline underline-offset-5 font-light text-[#515151] mt-5'>New Delhi, India</p>
        </div>
        <div className='dets font-neue mt-10'>
          <p className='block text-lg font-light text-[#515151]'>E:</p>
          <a className='block text-lg underline underline-offset-5 font-light text-[#515151] mt-5' href="">himanshujangir16@gmail.com</a>
        </div>
      </div>
    </div>
  )
